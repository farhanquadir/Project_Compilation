...
class CNN(nn.Module):
    ...
    def __init__(self, size, num_classes):
        ...
        self.extract = nn.Sequential( # lets make a 2D convolution layer
                                      ...
                                      nn.Conv2d( in_channels = 10, out_channels = 4, #28 x 28 x 10 x 4
        ...
        self.decimate = nn.Sequential( nn.Linear(28*28*4,512), nn.ReLU(inplace=True), nn.Linear(512,128), nn.ReLU(inplace=True),
                                      nn.Linear(128,64), nn.ReLU(inplace=True),#nn.Softmax() 
