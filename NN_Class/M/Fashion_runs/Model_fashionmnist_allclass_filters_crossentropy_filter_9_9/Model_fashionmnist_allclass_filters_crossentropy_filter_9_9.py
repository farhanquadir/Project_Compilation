...
class CNN(nn.Module):
    ...
    def __init__(self, size, num_classes):
        ...
        self.decimate = nn.Sequential( nn.Linear(12*12*4,128), nn.ReLU(inplace=True), #nn.Linear(512,128), nn.ReLU(inplace=True),
                                      nn.Linear(128,10), nn.ReLU(inplace=True),nn.Softmax() 
