...
class CNN(nn.Module):
    ...
    def __init__(self, size, num_classes):
        ...
        self.extract = nn.Sequential( # lets make a 2D convolution layer
                                      ...
                                      nn.ReLU(inplace = True)#,nn.Linear(2,1)#,nn.Sigmoid()
                                      #nn.MaxPool2d(2),                                                                
                                      #nn.Dropout(0.1),
                                      # ----------------------------------------------------------- 
        ...
        self.decimate = nn.Sequential( nn.Linear(2,1))
        """
...
#        sys.exit()
        ...
        optimizer.step()
        #break
        prediction = int(round(prediction.item(),0))
