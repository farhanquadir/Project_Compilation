...
# -*- coding: utf-8 -*-
"""
Created on Tue Nov 19 12:09:04 2019
...
if not data_augmentation:
    ...
    #                    validation_data=(x_test, y_test), epochs=epochs, verbose=1, callbacks=callbacks)
...
with open ("history_aug_"+sys.argv[0].replace(".py","_v2_n7_batch1.txt"),"w") as f:
